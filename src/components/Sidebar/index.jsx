...
const NavItem = ({icon, text}) => (
    <div className='felx items-center p3 rounded-full cursor-pointer hover:bg-gray-600 transition duration-200'>
        <FontAwesomeIcon icon={icon} className='text-2xl mr-4 mt-3'/>
...
export function Sidebar(){
    ...
    return(
        <div className="w-20 xl:w-64 sticky top-0 px-2 h-screen">
            <FontAwesomeIcon icon={faTwitter} className='text-blue-400 text-3xl mr-4'/>
            <nav>
                ...
                <NavItem icon={faBookmark} text="Book"/>
